...
if isunix
    ...
    run_string = ['system(''export LD_LIBRARY_PATH=''''/share/apps/cuda-10.0/lib64:/share/apps/gcc-5.5/lib64''''; cd ' binary_path '; ./' binary_name ' -i ' input_filename ' -o ' output_filename options_string ''' ,''-echo'');'];
    eval(run_string);
