...
#$ -l tscratch=30G
#$ -t 1:20#60:706#95-99 #282#255,277#246,253#,255,277,282
#=========MATLAB===============
...
export cmd="matlab -nodesktop -noFigureWindows -nodisplay -nosplash  -r  i0="$ITER";run('/home/gdisciac/k-wave/myscripts/scripts_victre/run_victre_paradigm.m');exit;"
echo $cmd
