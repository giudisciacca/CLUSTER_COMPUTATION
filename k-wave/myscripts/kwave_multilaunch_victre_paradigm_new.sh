...
#$ -S /bin/bash
#$ -j y
#$ -N tNew_USarray_VICTRE.sh
#$ -l gpu=true,gpu_rtx2080ti=yes
#$ -l tscratch=40G
#$ -t 1-200 #95-99 #282#255,277#246,253#,255,277,282
#=========MATLAB===============
...
#==========================
cd /home/gdisciac/k-wave/myscripts/scripts_victre
echo $PATH
export ITER=$SGE_TASK_ID
export cmd="matlab -nodesktop -noFigureWindows -nodisplay -nosplash  -r  i0="$ITER";run('/home/gdisciac/k-wave/myscripts/scripts_victre/run_victre_paradigm_new.m');exit;"
echo $cmd
