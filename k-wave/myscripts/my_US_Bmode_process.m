...
axis image;
scan_lines_fund_T = scan_lines_fund.';scan_lines_fund_T = scan_lines_fund_T(find(r>=5/1000 & r < FACT_scale *x),: );
...
axis image;
scan_lines_harm_T = scan_lines_harm.';scan_lines_harm_T = scan_lines_harm_T(find(r >= 5/1000 & r <  FACT_scale *x), :);
