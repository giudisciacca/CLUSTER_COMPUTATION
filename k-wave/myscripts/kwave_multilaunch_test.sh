...
cmd="matlab -nodesktop -noFigureWindows -nodisplay -nosplash  -r  i0="$ITER";run('/home/gdisciac/k-wave/myscripts/scripts_randomblob/Cluster_run_LargeExp_arraytest.m');exit;"
echo $cmd
