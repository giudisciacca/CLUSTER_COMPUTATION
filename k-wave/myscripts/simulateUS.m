...
pml_x_size = 20;%20;                % [grid points]
pml_y_size = 10;%128;                % [grid points]
pml_z_size = 10;%1;                % [grid points]

% set total number of grid points not including the PML
Nx = (3^2)*(2^5) - 2 * pml_x_size; %(3^3)*(2^3) - 2 * pml_x_size;      % [grid points]
Ny = (3^2)*(2^4) - 2 * pml_y_size;      % [grid points]
Nz = (3^2)*(2^3) - 2 * pml_z_size;      % [grid points]
