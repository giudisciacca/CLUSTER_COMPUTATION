...
#$ -S /bin/bash
#$ -j y
#$ -N mcxSOLUS_victre.sh
#$ -l gpu=true#,gpu_rtx2080ti=yes
##$ -l tscratch=20G
#$ -t 1:2#-8#730#95-99 #282#255,277#246,253#,255,277,282
# qrsh -l tmem=500M,gpu=true,h_rt=0:30:0
...
export cmd="matlab -nodesktop -noFigureWindows -nodisplay -nosplash -r gpuDevice([]);i0="$ITER";set_dir;cd('/home/gdisciac/SOLUS/example/VICTRE_PARADIGM');multiple_run_paradigm_clusterMC;exit;"
echo $cmd
echo Starting matlab

matlab -nodesktop -noFigureWindows -nodisplay -nosplash -r "i0=$ITER;DOT_install;set_dir;cd('/home/gdisciac/SOLUS/example/VICTRE_PARADIGM');multiple_run_paradigm_clusterMC;exit;"
