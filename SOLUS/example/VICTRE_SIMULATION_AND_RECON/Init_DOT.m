...
% mua_ = [ 0.0029    0.0022    0.0027    0.0072    0.0128    0.0267    0.0144    0.0086];
% %musp_ = [13.239025 12.28287 8.910008 7.3108825 7.121039 6.537811 5.882884 5.576854]/10;
% musp_=[ 0.9404    0.7489    0.7347    0.8344    0.7031    0.7868    0.7894    0.7730];
...
DOT.opt.hete1.geometry = 'LOAD_BKG';
...
DOT.opt.hete1.path =['VICTRE.mat'] ;   % down
...
%==========================================================================
DOT.time.dt = 25;dt =25;% (50e3/4096/6)*4;        % time step in picoseconds
DOT.time.nstep = 400; nstep=400;%4096/4;               % number of temporal steps
...
DOT.time.TotCounts = 2e6;           % total counts for the maximum-energy
...
DOT.radiometry.lambda = [635, 670, 685, 785, 905, 930, 975, 1060];%[635, 670, 830, 915, 940, 980, 1030, 1065];
