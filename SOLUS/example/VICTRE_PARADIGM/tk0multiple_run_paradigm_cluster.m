...
sumFailed = 0;
for isim = i0
    for imethod = {{'usprior',''},{'usprior','DT_'}}%{{'fit4param',''},{'fit4param','DT_'}}%{'usprior','DT_'},{'usprior',''} }% {{'fit4param',''},{'components_fit',''}}%,{'usprior','DT'}'}
TWstr = '20';
        % down
	...
	if strcmpi(imethod{1}{2},'DT_')
        ...
        str{2} = sprintf(['EXP_DATA=0;SPECTRA=1;NUM_TW = ',TWstr,';\n',....
                ...
                'RECFILE_APPEND = [''PARADIGM8_%s_type'',REC.solver.type,''_tau'',num2str(REC.solver.tau,''%%%%10.0e''),''_mu0%sSample%s''];\n',...
                'RECFILE_APPEND_DATA = [''PARADIGM8_mu0%sSample%s''];\n',...
                ],...
