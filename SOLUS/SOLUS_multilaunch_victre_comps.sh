...
matlab -nodesktop -noFigureWindows -nodisplay -nosplash -r "i0=$ITER;DOT_install;set_dir;cd('/home/gdisciac/SOLUS/example/VICTRE_PARADIGM');multiple_run_paradigm_cluster_comps;exit;"
