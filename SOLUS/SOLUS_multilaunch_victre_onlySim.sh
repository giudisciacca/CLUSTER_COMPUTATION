...
#$ -S /bin/bash
#$ -j y
#$ -N Sim_SOLUS_victre.sh
#$ -l gpu=true#,gpu_rtx2080ti=yes
##$ -l tscratch=20G
#$ -t 200-730#95-99 #282#255,277#246,253#,255,277,282
...
matlab -nodesktop -noFigureWindows -nodisplay -nosplash -r "gpuDevice([]);i0=$ITER;DOT_install;set_dir;cd('/home/gdisciac/SOLUS/example/VICTRE_PARADIGM');multiple_run_paradigm_onlySim;exit;"
