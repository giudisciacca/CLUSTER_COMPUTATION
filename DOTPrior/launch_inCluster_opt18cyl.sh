...
#$ -S /bin/bash
#$ -j y
#$ -N python_launch18.sh
#$ -l gpu=true,gpu_titanx=yes
#####  -pe gpu 1

q# qrsh -l tmem=16G,gpu=true,h_rt=0:30:0 -pe gpu 2
#=========MATLAB===============
...
# 16
#python DeepPrior_OpticalLoss_iter.py 'OpticalLoss_iter1_full_withEXP_frmw1b' 1 1 'FEMcyl' 1 'USadded'  ;
#17
#python DeepPrior_OpticalLoss_iter.py 'OpticalLoss_iter1_slice_withEXP_frmw1b' 0 1 'FEMcyl' 1 'USadded'  ;
#18
python DeepPrior_OpticalLoss_iter.py 'OpticalLoss_iter1_full_withEXP_frmw3b' 1 1 'FEMcyl' 1 'USonly'  ;
#19
#python DeepPrior_OpticalLoss_iter.py 'OpticalLoss_iter1_slice_withEXP_frmw3b' 0 1 'FEMcyl' 1 'USonly'  ;
