...
echo $PATH
export cmd="matlab -nodesktop -nodisplay -nosplash -nojvm -r Ilaunch="$SGE_TASK_ID";run('/home/gdisciac/mcx/mcxlab/examples/mcx_myscripts/master_mcx_sh_refl.m');exit;"
#echo $cmd
